...
- Native macOS Swift/SwiftPM menu-bar focus utility.
- Preserve focused menu-bar app behavior and current Swift Package Manager structure.
- Do not add accounts, telemetry, cloud services, or heavyweight frameworks unless explicitly requested.
...
- `Sources/AGENTS.md` — Swift source.
